...
const LinkText: React.FunctionComponent<LinkTextProps> = ({
  ...
  return (
    <Link
      className={cn(
        "flex flex-row items-center group justify-start gap-0.5 text-base font-medium transition-all text-zinc-900 dark:hover:text-zinc-50 dark:text-zinc-400 hover:text-zinc-700 hover:gap-1 active:text-orange-500",
        className
      )}
      {...attr}
      target={target}
